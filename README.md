...
<main id="home" class="container" role="main">
  ...
  <section class="section" id="services" aria-label="サービス日本語">
    ...
    <div class="cards">
      ...
      <div class="card">
        <strong>発音・音声表現の改善</strong>
        <p>発音の矯正、音韻意識訓練、舌・口腔機能の運動訓練を行い、家庭での練習法もご提案します。保護者様への具体的なサポートも提供します。</p>
      </div>
    </div>
  </section>
  ...
  <section class="section" id="services-2" aria-label="サービス日本語2">
    ...
    <div class="cards">
      ...
      <div class="card">
        <strong>発音サポート（成人）</strong>
        <p>成人の発音の安定と会話の明瞭さを向上させる訓練。舌位・口腔運動の指導、実生活での練習の適用を行います。家族へのアドバイスも提供します。</p>
      </div>
    </div>
  </section>
  ...
  <section class="section" id="online" aria-label="オンラインリハビリ日本語">
    ...
    <p style="margin-top:8px;color:var(--muted)">支払いは先払いの銀行振込です。振込先情報は申込後メールでご案内します。</p>
  </section>
  ...
  <section class="section" id="fees" aria-label="料金とお支払い日本語">
    ...
    <div class="grid-2">
      <div class="card">
        <strong>銀行振り込み（先払い）</strong>
        <p>支払いは先払いの銀行振込です。申込後、銀行振込先情報をメールで案内します。</p>
        <p>振込手数料は別途ご負担ください。振込確認後、サービスを提供します。</p>
      </div>
      <div class="card">
        <strong>メール相談（回数券）</strong>
        <p>1回のやりとり: 500円</p>
        <p>5回のやりとり: 2000円</p>
        <p>10回までのやりとり: 5000円</p>
        <p>支払いは先払いの銀行振込です。</p>
      </div>
    </div>
